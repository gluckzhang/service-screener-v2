...
class Screener:
    ...
    def scanByService(service, regions, filters):
        ...
        _zeroCount = {"resources": 0, "rules": 0, "exceptions": 0, "timespent": 0}
        ...
        for region in _regions:
            ...
            try:
                ...
                if (
                    eCode == "InvalidClientTokenId"
                    and _cli_options["crossAccounts"] == True
                ):
                    _warn(
                        "Impacted Region: [{}], Services: {}... Cross Account limitation, encounted errors: {}".format(
                            reg, service[0], e
                        )
                    )
    ...
    def getServicePagebuilderDynamically(service):
        ...
        ServiceClass = getattr(
            importlib.import_module("services.PageBuilder"), "PageBuilder"
        )
    ...
    @staticmethod
    def generateScreenerOutput(
        runmode, contexts, hasGlobal, regions, uploadToS3, bucket
    ):
        ...
        if runmode == "api-raw":
            ...
            for service, resultSets in contexts.items():
                ...
                if runmode == "report":
                    ...
                    pageBuilderClass = Screener.getServicePagebuilderDynamically(
                        service
                    )
                ...
                if runmode == "report" or runmode == "api-full":
                    if service not in apiResultArray:
